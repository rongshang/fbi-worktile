...
public class ElementBean implements Comparable,Cloneable {
    ...
    private skyline.platform.form.util.FieldFormat formatcls;
     ...
     */
    public skyline.platform.form.util.FieldFormat getFormatcls() {
        return formatcls;
    }
    ...
    public void setFormatcls(String formatcls, int type) {
        ...
        if (type == FormBean.LIST_TYPE || type == FormBean.QUERY_TYPE ) {
            try {
                skyline.platform.form.util.FieldFormat ff = (skyline.platform.form.util.FieldFormat) Class.forName(formatcls).newInstance();
                this.formatcls = ff;
            } catch (Exception ex) {
                this.formatcls = new skyline.platform.form.util.FieldFormat();
            }
        }
    }
