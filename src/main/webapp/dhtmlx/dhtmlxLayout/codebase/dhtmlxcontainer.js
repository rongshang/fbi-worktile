...
function dhtmlXContainer(i) {
    ...
    this.obj.setActive = function() {
        if (this.vs[this.av]) this.cv = this.av,
    ...
    this.obj._setPadding = function(a, b) {
        typeof a == "object" ? (this._offsetTop = a[0], this._offsetLeft = a[1], this._offsetWidth = a[2], this._offsetHeight = a[3], a = null) : (this._offsetLeft = this._offsetTop = a, this._offsetWidth = -a * 2, this._offsetHeight = -a * 2);
    ...
    this.obj.moveContentTo = function(a) {
        for (var b in this.vs) {
            ...
            c != null && (a.view(b).attachObject(this.vs[b][c + "Id"], !1, !0, !1), a.vs[b][c] = this.vs[b][c], a.vs[b][c + "Id"] = this.vs[b][c + "Id"], a.vs[b][c + "Obj"] = this.vs[b][c + "Obj"], this.vs[b][c] = null, this.vs[b][c + "Id"] = null, this.vs[b][c + "Obj"] = null);
            if (this.vs[b]._frame) a.vs[b]._frame = this.vs[b]._frame,
                this.vs[b]._frame = null;
            ...
            if (this.vs[b].toolbar != null) a.cv == a.av ? a.vs[a.av].dhxcont.insertBefore(document.getElementById(this.vs[b].toolbarId), a.vs[a.av].dhxcont.childNodes[a.vs[a.av].menu != null ? 1 : 0]) : (d = a._getSt(), d.appendChild(document.getElementById(this.vs[b].toolbarId)), d = null),
                a.vs[b].toolbar = this.vs[b].toolbar,
                a.vs[b].toolbarId = this.vs[b].toolbarId,
                a.vs[b].toolbarHeight = this.vs[b].toolbarHeight,
                this.vs[b].toolbar = null,
                this.vs[b].toolbarId = null,
                this.vs[b].toolbarHeight = null,
                this.cv == this.av && this._doOnAttachToolbar && this._doOnAttachToolbar("unload"),
                a.cv == a.av && a._doOnAttachToolbar && a._doOnAttachToolbar("move");
            if (this.vs[b].sb != null) {
                if (a.cv == a.av) a.vs[a.av].dhxcont.insertBefore(document.getElementById(this.vs[b].sbId), a.vs[a.av].dhxcont.childNodes[a.vs[a.av].dhxcont.childNodes.length - 1]);
                else return d = a._getSt(),
                    d.appendChild(document.getElementById(this.vs[b].sbId)),
                    d;
    ...
    this.obj.adjustContent = function(a, b, c, d, e) {
        ...
        if (f.offsetHeight > k - b) f.style.height = Math.max(0, (k - b) * 2 - f.offsetHeight) + "px";
        ...
        if (d !== !0 && (h.style.width = f.clientWidth + "px", h.offsetWidth > f.clientWidth)) h.style.width = Math.max(0, f.clientWidth * 2 - h.offsetWidth) + "px";
    ...
    this.obj.updateNestedObjects = function(a) {
        if (this.skin == "dhx_terrace") {
            ...
            if (this.vs[this.av].grid) {
                ...
                if (a) {
                    if (!this._isWindow) this.vs[this.av].grid.entBox.style.border = "0px solid white",
            ...
            if (this.vs[this.av].layout) a && !this._isWindow && !this._isCell && this.vs[this.av].layout._hideBorders(),
            ...
            if (this.vs[this.av].tabbar != null) c = !b && this._isCell && this._noHeader ? 0 : 14,
            ...
            if (this.vs[this.av].editor) e = c = 14,
    ...
    this.obj.detachStatusBar = function() {
        if (this.vs[this.av].sb) this.vs[this.av].sb.setText = null,
            ...
            this._viewRestore(),
            this._doOnAttachStatusBar && this._doOnAttachStatusBar("unload")
    };
    ...
    this.obj.attachGrid = function() {
        if (this._isWindow && this.skin == "dhx_skyblue") this.vs[this.av].dhxcont.mainCont[this.av].style.border = "#a4bed4 1px solid",
            this._redraw();
        var a = document.createElement("DIV");
        ...
        if (this.skin == "dhx_skyblue" || this.skin == "dhx_black" || this.skin == "dhx_blue") this.vs[this.av].grid.entBox.style.border = "0px solid white",
    ...
    this.obj.attachTabbar = function(a) {
        if (this._isWindow && this.skin == "dhx_skyblue") this.vs[this.av].dhxcont.style.border = "none",
        ...
        document.body.appendChild(b);
        this.attachObject(b.id, !1, !0, !1);
        if (this._isCell) this.hideHeader(),
            this._padding = b._hideBorders = !1;
    ...
    this.obj.attachAccordion = function() {
        ...
        this._padding = !0;
        if (this.skin == "dhx_web") a.style.left = "0px",
            a.style.top = "0px",
            a.style.width = parseInt(this.vs[this.av].dhxcont.mainCont[this.av].style.width) + "px",
            a.style.height = parseInt(this.vs[this.av].dhxcont.mainCont[this.av].style.height) + "px";
        else if (this.skin != "dhx_terrace") a.style.left = "-1px",
            a.style.top = "-1px",
            a.style.width = parseInt(this.vs[this.av].dhxcont.mainCont[this.av].style.width) + 2 + "px",
            a.style.height = parseInt(this.vs[this.av].dhxcont.mainCont[this.av].style.height) + 2 + "px";
    ...
    this.obj.attachLayout = function(a, b) {
        if (this._isCell && this.skin == "dhx_skyblue") this.hideHeader(),
        ...
        if ((this._isTabbarCell || this._isAcc) && this.skin == "dhx_skyblue") c.style.left = "-1px",
            c.style.top = "-1px",
        ...
        if (this.skin == "dhx_terrace") {
            if (this._isCell) this.style.backgroundColor = "transparent",
    ...
    this.obj.attachEditor = function(a) {
        ...
        this.attachObject(b.id, !1, !0, !1);
        this.vs[this.av].editor = new dhtmlXEditor(b.id, a || this.skin);
    ...
    this.obj.attachObject = function(a, b, c, d) {
        ...
        if (b && this._isWindow) a.style.visibility = "",
            this._adjustToContent(e, f);
        if (this.skin == "dhx_terrace" && (this.vs[this.av].menu != null || this.vs[this.av].toolbar != null)) this.adjust(typeof d == "undefined" || d == !0),
            this.updateNestedObjects(!0);
        c || this._viewRestore()
    };
    this.obj.detachObject = function(a, b) {
        for (var c = null,
                 d = null,
                 e = "tree,grid,layout,tabbar,accordion,folders".split(","), f = 0; f < e.length; f++) if (this.vs[this.av][e[f]]) {
        ...
        if (a && this.vs[this.av]._frame) this._detachURLEvents(),
            this.vs[this.av]._frame = null;
        for (var h = this.vs[this.av].dhxcont.mainCont[this.av]; h.childNodes.length > 0;) if (a == !0) h.removeChild(h.childNodes[0]);
        else {
    ...
    this.obj.attachURL = function(a, b) {
        ...
        if (this.skin == "dhx_terrace" && (this.vs[this.av].menu != null || this.vs[this.av].toolbar != null)) this.adjust(!0),
            this.updateNestedObjects(!0);
        this._viewRestore()
    };
    this.obj.adjust = function(a) {
        if (this.skin == "dhx_skyblue") {
            if (this.vs[this.av].menu) {
                if (this._isWindow || this._isLayout) this.vs[this.av].menu._topLevelOffsetLeft = 0,
                ...
                if (this._isCell) document.getElementById(this.vs[this.av].menuId).className += " in_layoutcell",
                    this.vs[this.av].menuHeight = 25;
                if (this._isAcc) document.getElementById(this.vs[this.av].menuId).className += " in_acccell",
                    this.vs[this.av].menuHeight = 25;
        ...
        if (this.skin == "dhx_terrace") {
            ...
            var c = 0;
            if (this._isWindow || this._isCell || this._isAcc || this._isTabbarCell) c = 14;
            this._isCell && this._noHeader && (c = 0);
            var d = a == !0 && !this.vs[this.av].toolbar || this._isLayout ? 14 : 0,
                e = a == !0 || this._isLayout ? 14 : 0,
                f = !1;
            if (this.vs[this.av].menu) document.getElementById(this.vs[this.av].menuId).style.marginLeft = b + "px",
                document.getElementById(this.vs[this.av].menuId).style.marginRight = b + "px",
                ...
                this._doOnAttachMenu && this._doOnAttachMenu("show"),
                f = !0;
            if (this.vs[this.av].toolbar) c == 0 && this.vs[this.av].menu != null & this._isCell && (c = 14),
                document.getElementById(this.vs[this.av].toolbarId).style.marginLeft = b + "px",
                document.getElementById(this.vs[this.av].toolbarId).style.marginRight = b + "px",
                ...
                this.vs[this.av].toolbarHeight = 32 + c + e,
    ...
    this.obj._attachContent = function(a, b, c) {
        if (c !== !0) {
            if (this.vs[this.av]._frame) this._detachURLEvents(),
                this.vs[this.av]._frame = null;
        ...
        if (a == "url") {
            if (this._isWindow && b.cmp == null && this.skin == "dhx_skyblue") this.vs[this.av].dhxcont.mainCont[this.av].style.border = "#a4bed4 1px solid",
                this._redraw();
    ...
    this.obj.showMenu = function() {
        if (this.vs[this.av].menu && this.vs[this.av].menuId && document.getElementById(this.vs[this.av].menuId).style.display == "none") this.vs[this.av].menuHidden = !1,
            this._doOnAttachMenu && this._doOnAttachMenu("show"),
            document.getElementById(this.vs[this.av].menuId).style.display = "",
            this._viewRestore()
    };
    this.obj.hideMenu = function() {
        if (this.vs[this.av].menu && this.vs[this.av].menuId && document.getElementById(this.vs[this.av].menuId).style.display != "none") document.getElementById(this.vs[this.av].menuId).style.display = "none",
            this.vs[this.av].menuHidden = !0,
            this._doOnAttachMenu && this._doOnAttachMenu("hide"),
            this._viewRestore()
    };
    this.obj.showToolbar = function() {
        if (this.vs[this.av].toolbar && this.vs[this.av].toolbarId && document.getElementById(this.vs[this.av].toolbarId).style.display == "none") this.vs[this.av].toolbarHidden = !1,
            this._doOnAttachToolbar && this._doOnAttachToolbar("show"),
            document.getElementById(this.vs[this.av].toolbarId).style.display = "",
            this._viewRestore()
    };
    this.obj.hideToolbar = function() {
        if (this.vs[this.av].toolbar && this.vs[this.av].toolbarId && document.getElementById(this.vs[this.av].toolbarId).style.display != "none") this.vs[this.av].toolbarHidden = !0,
    ...
    this.obj.showStatusBar = function() {
        if (this.vs[this.av].sb && this.vs[this.av].sbId && document.getElementById(this.vs[this.av].sbId).style.display == "none") this.vs[this.av].sbHidden = !1,
    ...
    this.obj.hideStatusBar = function() {
        if (this.vs[this.av].sb && this.vs[this.av].sbId && document.getElementById(this.vs[this.av].sbId).style.display != "none") this.vs[this.av].sbHidden = !0,
    ...
    this.obj._dhxContDestruct = function() {
        var a = this.av,
            b;
        for (b in this.vs) this.av = b,
            this.detachMenu(),
            this.detachToolbar(),
            this.detachStatusBar(),
            this.detachObject(!0),
            this.vs[b].dhxcont.mainCont[b] = null;
        for (b in this.vs) this.vs[b].dhxcont.mainCont = null,
            this.vs[b].dhxcont.innerHTML = "",
            this.vs[b].dhxcont = null,
            this.vs[b] = null;
