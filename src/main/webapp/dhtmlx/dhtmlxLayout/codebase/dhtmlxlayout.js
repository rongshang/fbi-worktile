...
function dhtmlXLayoutObject(k, l, m) {
    if (window.dhtmlXContainer) {
        ...
        this.skin = m != null ? m: typeof dhtmlx != "undefined" && typeof dhtmlx.skin == "string" ? dhtmlx.skin: this._autodetectSkin();
        ...
        if ((typeof k == "object" || k == document.body) && !this.base) {
            ...
            if (k == document.body) this._lw = this._tmTime = null,
            ...
            k._doOnAttachToolbar = function() {
                j != null && typeof j.setSizes == "function" && j.setSizes()
            }
        }
        this.items = [];
        ...
        this._minHeight = this._minWidth = 40;
        ...
        this._attachSizer = function(a) {
            ...
            j.sizer.style.width = a.offsetWidth + "px";
        ...
        this._xmlParser = function() {
            for (var a = [], c = [], f = {},
                     d = this.getXMLTopNode("layout"), b = 0; b < d.childNodes.length; b++) {
                    ...
                    for (var i = 0; i < e.childNodes.length; i++) if (e.childNodes[i].tagName == "cell") {
                        ...
                        if (h.getAttribute("obj") != null) {
                            for (var y = h.getAttribute("obj"), k = String(h.getAttribute("wh")).split(","), l = isNaN(k[0]), m = isNaN(k[0]) ? parseInt(j.polyObj[k[0]].style.width) : 0, n = 0; n < a.length; n++) for (var p = 0; p < a[n].length; p++) if (a[n][p] == y) {
                                if (!l) {
                                    for (var l = !0,
                                             G = j.base.offsetWidth - f[y][0] * j.skinParams[j.skin].ver_sep_width, w = 0; w < a[n].length; w++) isNaN(a[n][w]) || (G -= a[n][w], k[0] -= 1);
                                    m = Math.ceil(G / k[0])
                                }
                                a[n][p] = m
                            }
                            ...
                            for (var l = isNaN(k[1]), t = isNaN(k[1]) ? parseInt(j.polyObj[k[1]].style.height) : 0, n = 0; n < c.length; n++) for (p = 0; p < c[n].length; p++) if (c[n][p] == y) {
                                if (!l) {
                                    for (var l = !0,
                                             v = j.base.offsetHeight - f[y][1] * j.skinParams[j.skin].hor_sep_height, w = 0; w < c.length; w++) isNaN(c[w][p]) || (v -= c[w][p], k[1] -= 1);
                                    t = Math.ceil(v / k[1])
                                }
                                c[n][p] = t
                            }
                        ...
                        if (h.getAttribute("sep") != null) {
                            var H = h.getAttribute("sep");
                            if (H == "hor") {
                                o.className = "dhtmlxLayoutPolySplitterHor";
                                o._dir = "hor";
                                for (var C = h.getAttribute("top").split(";"), q = 0; q < C.length; q++) u = String(C[q]).split(","),
                                    u.length > 1 && (C[q] = u);
                                o._top = C;
                                for (var D = h.getAttribute("bottom").split(";"), q = 0; q < D.length; q++) u = String(D[q]).split(","),
                                    u.length > 1 && (D[q] = u);
                                o._bottom = D;
                                ...
                                for (var E = h.getAttribute("left").split(";"), q = 0; q < E.length; q++) u = String(E[q]).split(","),
                                    u.length > 1 && (E[q] = u);
                                o._left = E;
                                for (var F = h.getAttribute("right").split(";"), q = 0; q < F.length; q++) u = String(F[q]).split(","),
                                    u.length > 1 && (F[q] = u);
                                o._right = F;
                ...
                if (d.childNodes[b].tagName == "autosize") j._autoHor = d.childNodes[b].getAttribute("hor").split(";"),
                    j._autoVer = d.childNodes[b].getAttribute("ver").split(";"),
                    j._totalCols = d.childNodes[b].getAttribute("cols"),
                    j._totalRows = d.childNodes[b].getAttribute("rows"),
                    j._dimension[0] = j._totalCols * j._colsRatio,
                    j._dimension[1] = j._totalRows * j._rowsRatio;
                if (d.childNodes[b].tagName == "table") {
                    for (var I = d.childNodes[b].getAttribute("data"), w = String(I).split(";"), n = 0; n < w.length; n++) {
                        a[n] = [];
                        c[n] = [];
                        for (var z = String(w[n]).split(","), p = 0; p < z.length; p++) a[n][p] = z[p],
                            c[n][p] = z[p],
                            f[z[p]] == null && (f[z[p]] = [0, 0])
                    }
                    for (var A in f) {
                        l = !1;
                        for (n = 0; n < a.length; n++) for (p = 0; p < a[n].length; p++) if (a[n][p] == A && !l) {
                            for (var l = !0,
                                     x = 0; x < a[n].length; x++) a[n][x] != A && f[A][0]++;
        ...
        this.setAutoSize = function(a, c) {
            if (a != null) {
                for (var f = !1,
                         d = this._availAutoSize[this._layoutView + "_hor"], b = 0; b < d.length; b++) f = f || d[b] == a;
        ...
        this._buildSurface = function() {
            for (var a = 0; a < this.tpl.childNodes[0].childNodes.length; a++) for (var c = this.tpl.childNodes[0].childNodes[a], f = 0; f < c.childNodes.length; f++) {
                ...
                if (!d._isSep) d._isCell = !0,
                    ...
                    d.collapse = function() {
                        b._isCollapsed(this._idd) || b._collapse(this._idd, "hide")
                    },
                ...
                if (d._dir == "ver") d.onselectstart = function(a) {
                    ...
                    d[this._isIPad ? "ontouchstart": "onmousedown"] = function(a) {
                        ...
                        if (d[0] != null && d[1] != null) {
                            ...
                            b._resX = b._isIPad ? a.touches[0].clientX: a.clientX;
                    ...
                    d.onmouseup = function() {
                        if (b._effects.resize == !0) b._resizeStop(),
                            b._anyExpL = null,
                            b._anyExpR = null
                    };
                if (d._dir == "hor") d.onselectstart = function(a) {
                    ...
                    d[this._isIPad ? "ontouchstart": "onmousedown"] = function(a) {
                        ...
                        if (d[0] != null && d[1] != null) {
                            ...
                            b._anyExpB = d[1];
                            b._collectResAreaData(d);
                            b._resY = b._isIPad ? a.touches[0].clientY: a.clientY;
                            if (b._effects.resize == !1) {
                                b._attachSizer(this);
                                ...
                                if (b._alterSizes.length > 0) for (var h = 0; h < b._alterSizes.length; h++) {
                                    for (var g = 0; g < b._anyExpT.length; g++) if (b._alterSizes[h][0] == b._anyExpT[g]) {
                                        var i = parseInt(e.style.height) - b._alterSizes[h][2] - (e.childNodes[0].style.display != "none" ? b.skinParams[b.skin].cpanel_height: 0);
            ...
            for (var e in this.polyObj) {
                ...
                h.className = "dhxcont_global_content_area";
        ...
        this._collapse = function(a, c) {
            if (!this._isCollapsed(a)) this.polyObj[a]._savedW = parseInt(this.polyObj[a].style.width),
                this.polyObj[a]._savedH = parseInt(this.polyObj[a].style.height),
        ...
        this._findDockCellsVer = function(a) {
            ...
            if (a == null) return c;
            for (var f = null,
                     d = a._left.length - 1; d >= 0; d--) if (f == null) if (typeof a._left[d] == "object") {
                for (var b = !1,
                         e = 0; e < a._left[d].length; e++) b = b || this.polyObj[a._left[d][e]]._isBlockedWidth || !1;
                b || (f = a._left[d])
            } else this.polyObj[a._left[d]]._collapsed == !1 && (this.polyObj[a._left[d]]._isBlockedWidth || (f = a._left[d]));
            for (var g = null,
                     d = 0; d < a._right.length; d++) if (g == null) if (typeof a._right[d] == "object") {
                b = !1;
                for (e = 0; e < a._right[d].length; e++) b = b || this.polyObj[a._right[d][e]]._isBlockedWidth || !1;
                b || (g = a._right[d])
            } else this.polyObj[a._right[d]]._collapsed == !1 && (this.polyObj[a._right[d]]._isBlockedWidth || (g = a._right[d]));
            ...
            if (this._alterSizes.length > 0 && this._effects.resize == !0) {
                ...
                for (d = 0; d < i.length; d++) for (e = 0; e < this._alterSizes.length; e++) if (this._alterSizes[e][0] == i[d]._idd && this._minWLAlter < this._alterSizes[e][1]) this._minWLAlter = this._alterSizes[e][1];
        ...
        this._findDockCellsHor = function(a) {
            ...
            if (a == null) return c;
            for (var f = null,
                     d = a._top.length - 1; d >= 0; d--) if (f == null) if (typeof a._top[d] == "object") {
                for (var b = !1,
                         e = 0; e < a._top[d].length; e++) b = b || this.polyObj[a._top[d][e]]._isBlockedHeight || !1;
                b || (f = a._top[d])
            } else this.polyObj[a._top[d]]._collapsed == !1 && (this.polyObj[a._top[d]]._isBlockedHeight || (f = a._top[d]));
            for (var g = null,
                     d = 0; d < a._bottom.length; d++) if (g == null) if (typeof a._bottom[d] == "object") {
                b = !1;
            ...
            if (this._alterSizes.length > 0 && this._effects.resize == !0) {
                ...
                for (d = 0; d < h.length; d++) for (e = 0; e < this._alterSizes.length; e++) if (this._alterSizes[e][0] == h[d]._idd && this._minHBAlter < this._alterSizes[e][2]) this._minHBAlter = this._alterSizes[e][2]
            }
            return c
        };
        this._resizeVer = function(a) {
            ...
            if (! (this._resObj == null || this._anyExpL == null || this._anyExpR == null)) {
                ...
                if (this._effects.resize == !1) {
                    ...
                    if ( - f > this._resXMaxWidthLeft && f < 0) f = -this._resXMaxWidthLeft,
                        this._resX = f + this._resXStart;
                    if (f > this._resXMaxWidthRight && f > 0) f = this._resXMaxWidthRight,
                        this._resX = f + this._resXStart;
                    this.sizer.style.left = this.sizer._leftXStart + f + "px"
                } else {
                    for (var d = this._anyExpL,
                             b = this._anyExpR,
                             e = c,
                             f = c - j._resX,
                             g = [], i = [], h = 0; h < d.length; h++) g[h] = this.polyObj[d[h]];
                    for (h = 0; h < b.length; h++) i[h] = this.polyObj[b[h]];
                    var k = parseInt(g[0].style.width),
                        l = parseInt(i[0].style.width);
                    if (f < 0) {
                        var m = k + f;
                        if (m > g[0]._minW && m > this._minWLAlter) {
                            for (var r = l + k - m,
                                     h = 0; h < g.length; h++) this._setW(g[h], m);
        ...
        this._resizeHor = function(a) {
            if (! (this._resObj == null || this._anyExpT == null || this._anyExpB == null)) {
                ...
                if (this._effects.resize == !1) {
                    ...
                    if ( - f > this._resYMaxHeightTop && f < 0) f = -this._resYMaxHeightTop,
                        this._resY = f + this._resYStart;
                    if (f > this._resYMaxHeightBottom && f > 0) f = this._resYMaxHeightBottom,
                        this._resY = f + this._resYStart;
                    this.sizer.style.top = this.sizer._topYStart + f + "px"
                } else {
                    for (var d = this._anyExpT,
                             b = this._anyExpB,
                             e = c,
                             f = c - j._resY,
                             g = [], i = [], h = 0; h < d.length; h++) g[h] = this.polyObj[d[h]];
                    for (h = 0; h < b.length; h++) i[h] = this.polyObj[b[h]];
                    var k = parseInt(g[0].style.height),
                        l = parseInt(i[0].style.height);
                    if (f < 0) {
                        var m = k + f;
                        if (m > g[0]._minH + this._minHTAlter) {
                            for (var r = l + k - m,
                                     h = 0; h < g.length; h++) this._setH(g[h], m);
        ...
        this._resizeStop = function() {
            ...
            if (this._resObj != null) if (this._effects.resize == !1) {
                ...
                if (this._resObj._dir == "hor") {
                    var c = typeof this._anyExpT[0] == "object" ? this._anyExpT[0][0] : this._anyExpT[0],
                        f = this._resY - this._resYStart,
                        d = parseInt(this.polyObj[c].style.height) + f;
                    this._setHeight(c, d)
                } else {
                    var b = typeof this._anyExpL[0] == "object" ? this._anyExpL[0][0] : this._anyExpL[0],
                        e = this._resX - this._resXStart,
                        g = parseInt(this.polyObj[b].style.width) + e;
                    this._setWidth(b, g)
                }
                var i = {},
                    h = function(a) {
                        if (a != null) for (var b = 0; b < a.length; b++) typeof a[b] == "object" && h(a[b]),
                            i[a[b]] = !0
                    };
                h(this._anyExpT);
                h(this._anyExpB);
                ...
                if (typeof this._anyExpT == "object" && this._anyExpT != null) this.updateNestedObjectsArray(this._anyExpT),
                    this._anyExpT = null;
                if (typeof this._anyExpB == "object" && this._anyExpB != null) this.updateNestedObjectsArray(this._anyExpB),
                    this._anyExpB = null;
                if (typeof this._anyExpL == "object" && this._anyExpL != null) this.updateNestedObjectsArray(this._anyExpL),
                    this._anyExpL = null;
                if (typeof this._anyExpR == "object" && this._anyExpR != null) this.updateNestedObjectsArray(this._anyExpR),
                    this._anyExpR = null;
                this._resFunc = this._resObj = null;
                this._hideCovers();
                this._fixToolbars();
                this._fixCollapsedText();
                this.callEvent("onPanelResizeFinish", [j])
            } else {
                var l = [];
                ...
                this._hideCovers();
                for (var s = [], m = 0; m < l.length; m++) if (typeof l[m] == "object") for (var n = 0; n < l[m].length; n++) s[s.length] = this.polyObj[l[m][n]];
                else s[s.length] = this.polyObj[l[m]];
        ...
        this._isResizable = function(a) {
            for (var c = !1,
                     f = 0; f < this._resAreaData.length; f++) c = c || this._resAreaData[f] == a;
            return c
        };
        ...
        this._doOnDoubleClick = function(a) {
            if (a._dblClick != null && this.polyObj[a._dblClick] != null && !this.polyObj[a._dblClick]._noHeader) {
                ...
                if (c.childNodes[0].style.display != "none") return c._collapsed == !0 ? this._doExpand(c._resize, a._dblClick, c._rowData, "hide") : (c._savedW = parseInt(c.style.width), c._savedH = parseInt(c.style.height), this._doCollapse(c._resize, a._dblClick, c._rowData, "hide")),
                    !0
            }
        };
                ...
                if (b != -1) {
                    ...
                    if (g != null) {
                        ...
                        if (a == "hor") {
                            for (var i = 65536,
                                     e = 0; e < g.length; e++) {
                                var h = this.polyObj[g[e]].vs[this.polyObj[g[e]].av].layout != null ? this.polyObj[g[e]].vs[this.polyObj[g[e]].av].layout._defineWindowMinDimension(this.polyObj[g[e]], !0) : [0, 0],
                                    j = parseInt(this.polyObj[g[e]].style.width) - this._minWidth - h[1];
                                j < i && (i = j)
                            }
                            ...
                            i = 65536;
                            for (e = 0; e < g.length; e++) h = this.polyObj[g[e]].vs[this.polyObj[g[e]].av].layout != null ? this.polyObj[g[e]].vs[this.polyObj[g[e]].av].layout._defineWindowMinDimension(this.polyObj[g[e]], !0) : [0, 0, 0],
                                j = parseInt(this.polyObj[g[e]].style.height) - this._minHeight - h[2],
                                j < i && (i = j);
                        ...
                        this._expandEffect(this.polyObj[c], m, k, d, this._effects.collapse == !0 ? l: 1E6, a)
                    }
                }
            }
        };
            ...
            if (! (f.length <= 1)) {
                ...
                if (b != -1) {
                    ...
                    if (g != null) {
                        ...
                        var h = a == "hor" ? Math.round(Math.max(this.polyObj[c].offsetWidth, this.polyObj[g[0]].offsetWidth) / 3) : Math.round(Math.max(this.polyObj[c].offsetHeight, this.polyObj[g[0]].offsetHeight) / 3);
        ...
        this._expandEffect = function(a, c, f, d, b, e) {
            if (e == "hor") var g = parseInt(a.style.width),
                i = parseInt(c[0].style.width);
            else g = parseInt(a.style.height),
            ...
            for (var k = 0; k < c.length; k++) e == "hor" ? (c[k].style.width = i + g - h + "px", c[k].childNodes[0].style.width = c[k].style.width) : (c[k].style.height = i + g - h + "px", c[k].childNodes[0].style.height = c[k].style.height),
                c[k].adjustContent(c[k].childNodes[0], c[k]._noHeader ? 0 : this.skinParams[this.skin].cpanel_height);
        ...
        this._collapseEffect = function(a, c, f, d, b) {
            if (b == "hor") var e = parseInt(a.style.width),
                g = parseInt(c[0].style.width);
            else e = parseInt(a.style.height),
                g = parseInt(c[0].style.height);
            var i = e - d;
            if (b == "hor") {
            ...
            for (var h = 0; h < c.length; h++) b == "hor" ? (c[h].style.width = g + (e - i) + "px", c[h].childNodes[0].style.width = c[h].style.width) : (c[h].style.height = g + (e - i) + "px", c[h].childNodes[0].style.height = c[h].style.height),
                c[h].adjustContent(c[h].childNodes[0], c[h]._noHeader ? 0 : this.skinParams[this.skin].cpanel_height);
            if (i > this._collapsedW && b == "hor" || i > this._collapsedH && b == "ver") window.setTimeout(function() {
                    j._collapseEffect(a, c, f, d, b)
                },
                4);
            else {
                for (h = 0; h < c.length; h++) b == "hor" ? (c[h].style.width = g + (e - i) + "px", c[h].childNodes[0].style.width = c[h].style.width) : (c[h].style.height = g + (e - i) + "px", c[h].childNodes[0].style.height = c[h].style.height),
                    c[h].adjustContent(c[h].childNodes[0], c[h]._noHeader ? 0 : this.skinParams[this.skin].cpanel_height);
                a._collapsed = !0;
        ...
        this._setWidth = function(a, c) {
            if (this.polyObj[a] != null && Number(c)) {
                for (var f = null,
                         d = 0; d < this.sepVer.length; d++) {
                    var b = this.sepVer[d]._left;
                    if (b[b.length - 1] == a) f = [this.sepVer[d], "left"];
                    else if (typeof b[b.length - 1] == "object") for (var e = b[b.length - 1], g = 0; g < e.length; g++) e[g] == a && (f = [this.sepVer[d], "left"]);
                    b = this.sepVer[d]._right;
                    if (b[0] == a) f = [this.sepVer[d], "right"];
                ...
                if (f != null) {
                    var i = this._findDockCellsVer(f[0]),
                        h = i[0],
                        j = i[1];
                    if (! (h == null || j == null)) {
                        var k = parseInt(this.polyObj[h[0]].style.width) + parseInt(this.polyObj[j[0]].style.width);
                        c < this._minWidth ? c = this._minWidth: c > k - this._minWidth && (c = k - this._minWidth);
                        for (var l = k - c,
                                 d = 0; d < h.length; d++) this._setW(this.polyObj[h[d]], f[1] == "left" ? c: l),
                            this.polyObj[h[d]].updateNestedObjects();
                        for (d = 0; d < j.length; d++) this._setW(this.polyObj[j[d]], f[1] == "right" ? c: l),
                            this.polyObj[j[d]].updateNestedObjects()
                    }
                }
            }
        };
        this._setHeight = function(a, c) {
            if (this.polyObj[a] != null && Number(c)) {
                for (var f = null,
                         d = 0; d < this.sepHor.length; d++) {
                    var b = this.sepHor[d]._top;
                    if (b[b.length - 1] == a) f = [this.sepHor[d], "top"];
                    else if (typeof b[b.length - 1] == "object") for (var e = b[b.length - 1], g = 0; g < e.length; g++) e[g] == a && (f = [this.sepHor[d], "top"]);
                    b = this.sepHor[d]._bottom;
                    if (b[0] == a) f = [this.sepHor[d], "bottom"];
                    else if (typeof b[0] == "object") {
                        e = b[0];
                ...
                if (f != null) {
                    var i = this._findDockCellsHor(f[0]),
                        h = i[0],
                        j = i[1];
                    if (! (h == null || j == null)) {
                        var k = parseInt(this.polyObj[h[0]].style.height) + parseInt(this.polyObj[j[0]].style.height);
                        c < this._minHeight ? c = this._minHeight: c > k - this._minHeight && (c = k - this._minHeight);
                        for (var l = k - c,
                                 d = 0; d < h.length; d++) this._setH(this.polyObj[h[d]], f[1] == "top" ? c: l),
                            this.polyObj[h[d]].updateNestedObjects();
                        for (d = 0; d < j.length; d++) this._setH(this.polyObj[j[d]], f[1] == "bottom" ? c: l),
                            this.polyObj[j[d]].updateNestedObjects()
                    }
                }
            }
        ...
        this.dockWindow = function(a) {
            if (this.dhxWins && this.dhxWins.window(this.dhxWinsIdPrefix + a)) this.dhxWins.window(this.dhxWinsIdPrefix + a).close(),
                this.dhxWins.window(this.dhxWinsIdPrefix + a).moveContentTo(this.polyObj[a]),
                this.polyObj[a]._isUnDocked = !1,
        ...
        this._initWindows = function(a) {
            if (window.dhtmlXWindows) {
                ...
                if (this.dhxWins.window(c)) this.dhxWins.window(c).show();
                else {
                    var f = this,
                    ...
                    d.button("dock").show();
                    d.button("dock").attachEvent("onClick",
                        function() {
                            f.polyObj[a].dock()
                        });
        ...
        this._changeCPanelText = function(a, c) {
            var f = j;
            if (f.polyObj[a] != null) f.polyObj[a].childNodes[0].childNodes[0].childNodes[0].innerHTML = c,
                j.dhxWins != null && j.dhxWins.window(j.dhxWinsIdPrefix + a) != null && j.dhxWins.window(j.dhxWinsIdPrefix + a).setText(c)
        };
        ...
        this._fixSize = function(a, c, f) {
            if (this.polyObj[a] != null) this.polyObj[a]._isBlockedWidth = c,
                this.polyObj[a]._isBlockedHeight = f,
                this._fixSplitters()
        };
        this._fixSplitters = function() {
            ...
            for (a = 0; a < this.sepHor.length; a++) if (c = this._findDockCellsHor(this.sepHor[a]), c[0] == null || c[1] == null) {
                if (this.sepHor[a].className != "dhtmlxLayoutPolySplitterHorInactive") this.sepHor[a].className = "dhtmlxLayoutPolySplitterHorInactive"
        ...
        this._fixIcons = function() {
            for (var a in this.polyObj) {
                ...
                var e = null;
                if (d != -1) {
                    for (b = d + 1; b < c.length; b++) typeof c[b] == "object" ? e = this.polyObj[a]._resize == "ver" ? f ? "b": "t": f ? "r": "l": this.polyObj[c[b]]._collapsed == !1 && (e = this.polyObj[a]._resize == "ver" ? f ? "b": "t": f ? "r": "l");
        ...
        this._defineWindowMinDimension = function(a, c) {
            ...
            var d = j._getNearestParents("hor"),
                b = j._getNearestParents("ver");
            if (!c) {
                var e = [],
                    g = [],
                    i;
                ...
                for (var h = {},
                         k = {},
                         l = 0; l < j._alterSizes.length; l++) {
                    i = j._alterSizes[l][0];
                    var m = j._alterSizes[l][1],
                        r = j._alterSizes[l][2];
                    h[i] == null ? h[i] = m: m > h[i] && (h[i] = m);
                    k[i] == null ? k[i] = r: r > k[i] && (k[i] = r)
                }
        ...
        this._getNearestParents = function(a) {
            for (var c = a == "hor" ? this._autoHor: this._autoVer, f = {},
                     d = 0; d < c.length; d++) {
                var b = c[d];
        ...
        this.setSizes = function(a) {
            ...
            if (this.base.offsetParent) {
                ...
                var b = {},
                    e;
                for (e in this._getNearestParents("hor")) this.polyObj[e].style.width = Math.max(0, parseInt(this.polyObj[e].style.width) + f) + "px",
                    this.polyObj[e].childNodes[0].style.width = this.polyObj[e].style.width,
                    b[e] = 1;
                for (e in this._getNearestParents("ver")) this.polyObj[e].style.height = Math.max(0, parseInt(this.polyObj[e].style.height) + d) + "px",
                    this.polyObj[e].childNodes[0].style.height = this.polyObj[e].style.height,
                    b[e] = 1;
                for (e in b) this.polyObj[e].adjustContent(this.polyObj[e].childNodes[0], this.polyObj[e]._noHeader ? 0 : this.skinParams[this.skin].cpanel_height),
                    this.polyObj[e].updateNestedObjects();
...
dhtmlXLayoutObject.prototype.setCollapsedText = function(k, l) {
    if (this.polyObj[k]) {
        ...
        if (m.childNodes[m.childNodes.length - 1]._ct === !0) var j = m.childNodes[m.childNodes.length - 1];
        else j = document.createElement("DIV"),
            j._ct = !0,
            j.className = "dhtmlxInfoBarLabel_collapsed_" + this.polyObj[k]._resize,
            m.appendChild(j);
        j.innerHTML = l;
        this._fixCollapsedText();
        m = null
...
dhtmlXLayoutObject.prototype.attachHeader = function(k) {
    if (!this._ha) {
        ...
        this._ha.style.height = k.offsetHeight + "px";
        document.body.appendChild(this._ha);
        this._ha.appendChild(k);
        this._haEv = this.attachEvent("onResizeFinish",
            function() {
                this._ha.style.width = this.cont.obj.vs[this.cont.obj.av].dhxcont.style.width
            })
    }
...
dhtmlXLayoutObject.prototype.attachFooter = function(k) {
    if (!this._fa) {
        ...
        this._fa.style.height = k.offsetHeight + "px";
        document.body.appendChild(this._fa);
        this._fa.appendChild(k);
        this._faEv = this.attachEvent("onResizeFinish",
            function() {
                this._fa.style.width = this.cont.obj.vs[this.cont.obj.av].dhxcont.style.width
            })
    }
...
dhtmlXLayoutObject.prototype._hideBorders = function() {
    if (this.skin == "dhx_terrace") {
        ...
        for (var k in this.polyObj) this.polyObj[k]._setPadding(this.skinParams[this.skin].cell_pading_max, "dhxcont_layout_" + this.skin),
            this.polyObj[k].adjustContent(this.polyObj[k].childNodes[0], this.skinParams[this.skin].cpanel_height)
    }
};
