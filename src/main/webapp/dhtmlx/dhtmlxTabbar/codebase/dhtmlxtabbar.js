...
dhtmlXTabBar.prototype = {
    _get_size: function(a, b) {
        var c = this.entBox.getAttribute(a) || this.entBox.style[a] || (window.getComputedStyle ? window.getComputedStyle(this.entBox, null)[a] : this.entBox.currentStyle ? this.entBox.currentStyle[a] : 0); (c || "").indexOf("%") != -1 && this.enableAutoReSize(!0, !0);
    ...
    setSkin: function(a) {
        ...
        if (d && !this._custom_height) this._s.line_height = 37,
            this._setRowSizes();
        if (b) this._s.skin_line = 0;
        if (c) this._s.line_height = 29,
    ...
    _showScroll: function(a) {
        if (!this._rows[a]._scroll) {
            ...
            b[1].style.cssText = "background-image:url(" + this.imgUrl + this.skin + "/" + this.skin + "_scroll_right.gif); width:20px; height:21px;position:absolute;right:0px;z-index:990;top:" + c + "px;";
    ...
    _hideScroll: function(a) {
        ...
        if (this._rows[a]._scroll) this._rows[a].removeChild(this._rows[a]._scroll[0]),
            this._rows[a].removeChild(this._rows[a]._scroll[1]),
            this._rows[a]._scroll = null
    },
    _setRowSizes: function() {
        for (var a = 0; a < this._rows.length; a++) this._rows[a].style[this._dy] = this._s.line_height + "px",
            this._rows[a].style[this._py] = a * (this._s.line_height - (this._s.skin_line_x ? 4 : 2)) - (_isIE && !window.postMessage && this._s._bMode ? 0 : 0) + "px",
            this._rows[a].style.zIndex = 10 + a;
        this._setSizes()
    },
    _setTabSizes: function(a) {
        for (var b = this._a.offset,
                 c = this._s.align ? this._pxc: this._px, d = 0; d < a.tabCount; d++) {
    ...
    addTab: function(a, b, c, d, e) { ! this.__skin && dhtmlx.skin && this.setSkin(dhtmlx.skin);
        for (var e = e || 0,
                 f = this._rows.length; f <= e; f++) this._createRow();
        var g = this._rows[e].tabCount; ! d && d !== 0 && (d = g);
    ...
    _createTab: function(a, b, c) {
        ...
        this._close && (e += "<IMG style='" + this._pxc + ":4px; " + this._py + (this.skin == "dhx_web" ? ":7": ":4") + "px; position:absolute;z-index:11;' src='" + this.imgUrl + this.skin + "/close.png' >");
        d.innerHTML = e;
    ...
    _addTab: function(a, b, c, d) {
        ...
        a.tabCount++;
        if (c == "*") b.style.whiteSpace = "nowrap",
            this.adjustTabSize(b);
    ...
    adjustTabSize: function(a, b) {
        ...
        if (!b) a.style.fontWeight = "bold",
            a.childNodes[3].style[this._dx] = a.style[this._dx] = "10px",
            b = a[this._s._vMode ? "scrollHeight": "scrollWidth"] + 10 + (this._close ? 20 : 0),
            a.style.fontWeight = "";
    ...
    _showHover: function(a) {
        if (a != this._lastHower) {
            ...
            if (!a || !(a == this._lastActive || a._disabled)) if (this._lastHower = a) b = this._getSkin(a),
                a.className += " dhx_tab_hover",
                b.hover && (this._img(a.childNodes[1], 7, this._px, b.left), this._img(a.childNodes[2], 8, this._pxc, b.right)),
                this._img(a.childNodes[3], 0, this._px, parseInt(a.style[this._dx]) - (b.left + b.right), b.left)
        }
    },
    ...
    _onClickHandler: function(a) {
        ...
        if (c && !c._disabled) this.tabbar._setTabActive(c);
            ...
            var d = null;
            if (b.className == "dhx_tab_scroll_left") b.parentNode.scrollLeft = Math.max(0, b.parentNode.scrollLeft - b.parentNode.offsetWidth / 2),
                d = b,
                this.tabbar._setTabTop(this.tabbar._lastActive);
            else if (b.className == "dhx_tab_scroll_right") b.parentNode.scrollLeft += b.parentNode.offsetWidth / 2,
                d = b.previousSibling,
                this.tabbar._setTabTop(this.tabbar._lastActive);
    ...
    _setTabTop: function(a) {
        if (!a) return ! 1;
        for (var b = this._rows.length - 1,
                 c = 0; c < this._rows.length; c++) if (this._rows[c] == a.parentNode) {
            var d = this._rows[c];
    ...
    cells: function(a) {
        ...
        if (!this._content[a]) {
            ...
            b.skin = this.skin;
            this._conZone.appendChild(b); (new dhtmlXContainer(b)).setContent(b);
            ...
            b.autoSize = function() {
                if (c._awdj || c._ahdj) {
                    ...
                    if (c._awdj) c.entBox.style.width = b[0] + 2 + "px",
                        a.style.width = b[0] + "px";
                    if (c._ahdj) c._tabAll.style.height = c.entBox.style.height = b[1] + c._rows.length * (c._s.line_height - 2) + (c._s.expand ? 0 : 2) + 2 + "px",
            ...
            b._doOnFrameContentLoaded = function() { (c._awdj || c._ahdj) && c.cells(a).autoSize();
                c.callEvent("onXLE", []);
    ...
    _parseXML: function(a, b, c, d, e) {
        ...
        a._a.offset = parseInt(g.getAttribute("offset") || a._a.offset, 10); (i = g.getAttribute("skinColors")) && a.setSkinColors(i.split(",")[0], i.split(",")[1]);
        for (var j = 0; j < h.length; j++) for (var k = e.doXPath("./tab", h[j]), l = 0; l < k.length; l++) {
            ...
            else for (var p = 0; p < k[l].childNodes.length; p++) {
    ...
    getNext: function(a, b) {
        var b = b || "nextSibling",
            c = a[b];
        c && c.className.indexOf("dhx_tab_element") == -1 && (c = null); ! c && a.parentNode[b] && (c = a.parentNode[b].childNodes[0]);
        return c || a
    },
    getAllTabs: function() {
        var a = [],
    ...
    goToNextTab: function(a) {
        do a = this.getNext(a || this._lastActive);
    ...
    setContentHref: function(a, b) {
        ...
        switch (this._hrfmode) {
            ...
            case "ajax":
                ...
                if (!c.attachHTMLStringA) c.attachHTMLStringA = c.attachHTMLString,
                    c.attachHTMLString = function(a, b) {
    ...
    normalize: function(a, b) {
        ...
        for (var a = a || this._tabZone.offsetWidth,
                 d = [], e = 0; e < this._rows.length; e++) for (var f = 0; f < this._rows[e].tabCount; f++) d.push(this._rows[e].removeChild(this._rows[e].childNodes[0]));
        ...
        for (var h = 0,
                 ...
                 j = Infinity,
                 k = null,
                 f = 0; f < d.length; f++) i + d[f]._size + this._a.margin < a ? (this._rows[h].appendChild(d[f]), this._rows[h].tabCount++, i += d[f]._size + this._a.margin) : (b && i < j && c(this, f - 1), this._createRow(), f--, h++, j = i, i = this._a.offset);
    ...
    getNumberOfTabs: function() {
        for (var a = 0,
                 b = 0; b < this._rows.length; b++) a += this._rows[b].tabCount;
        return a
    },
    destructor: function() {}
};
if (!window.dhtmlXContainer) window.dhtmlXContainer = function(a) {
    ...
    this.obj.adjustContent = function(a, b, e, f, g) {
        ...
        if (this.dhxcont.offsetHeight > a.clientHeight - b) h = (a.clientHeight - b) * 2 - this.dhxcont.offsetHeight,
            h < 0 && (h = 0),
            this.dhxcont.style.height = h + "px";
    ...
    this.obj._attachContent = function(a, d, e) {
        ...
        } else if (a == "obj") b.dhxcont._frame = null,
            b.dhxcont.mainCont.appendChild(d),
            b.dhxcont.mainCont.style.overflow = e === !0 ? "auto": "hidden",
            d.style.display = "";
        else if (a == "str") b.dhxcont._frame = null,
            b.dhxcont.mainCont.innerHTML = d
    };
